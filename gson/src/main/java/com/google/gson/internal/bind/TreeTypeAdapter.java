...
public final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    public TreeTypeAdapter(@Nullable JsonSerializer<T> serializer, @Nullable JsonDeserializer<T> deserializer, Gson gson, TypeToken<T> typeToken, @Nullable TypeAdapterFactory skipPast) {
    ...
    private static final class SingleTypeFactory implements TypeAdapterFactory {
        ...
        SingleTypeFactory(Object typeAdapter, @Nullable TypeToken<?> exactType, boolean matchRawType, @Nullable Class<?> hierarchyType) {
