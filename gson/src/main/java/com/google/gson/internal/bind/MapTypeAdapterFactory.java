...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
  ...
  @NullUnmarked @Override public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
  ...
  private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
    ...
    @NullUnmarked @Override public Map<K, V> read(JsonReader in) throws IOException {
